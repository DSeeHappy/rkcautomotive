              ...
              <div className="relative flex h-full flex-col overflow-hidden shadow-2xl">
                {isFullBleed ? (
                  <>
                    ...
                    />
                    <div
                      className="pointer-events-none absolute inset-y-0 right-0 z-[1] hidden w-[52%] bg-gradient-to-l from-[#060a12]/55 via-[#060a12]/22 to-transparent lg:block"
                      aria-hidden
                    />
                    <div
                      className="pointer-events-none absolute inset-x-0 bottom-0 z-[1] h-[55%] bg-gradient-to-t from-[#060a12]/65 via-[#060a12]/28 to-transparent lg:hidden"
                      aria-hidden
                    />
                  </>
                ) : (
                ...
                >
                  ...
                  >
                    <div className="border-b border-white/10 p-6 sm:p-8 lg:pt-14">
                      <p className="text-xs font-semibold uppercase tracking-[0.2em] text-white/90 drop-shadow-[0_1px_2px_rgba(0,0,0,0.8)]">
                        {brand.name} · {model.yearRange}
                      </p>
                      <DialogTitle className="mt-1 font-display text-3xl tracking-wide text-white drop-shadow-[0_1px_3px_rgba(0,0,0,0.85)] sm:text-4xl">
                        {model.model}
                      </DialogTitle>
                    </div>
                    ...
                    <div className="flex-1 p-6 sm:p-8">
                      ...
                      <section className="mt-8">
                        <h3 className="flex items-center gap-2 text-sm font-semibold uppercase tracking-[0.16em] text-white drop-shadow-[0_1px_2px_rgba(0,0,0,0.8)]">
                        ...
                        <div className="mt-4 space-y-4">
                          {model.maintenanceSchedule.map((entry) => (
                            <div
                              key={entry.interval}
                              className="rounded-xl border border-white/15 border-l-4 border-l-primary-green bg-gradient-to-br from-black/80 to-[#0c1222]/70 p-4 shadow-lg backdrop-blur-lg sm:p-5"
                            >
                              <p className="text-base font-bold text-white drop-shadow-[0_1px_2px_rgba(0,0,0,0.8)] sm:text-lg">
                                {entry.interval}
                              </p>
                      ...
                      <div className="relative mt-10 flex flex-wrap gap-3 border-t border-white/10 pt-8">
                        {isFullBleed && (
                          <div
                            className="pointer-events-none absolute -inset-x-6 -bottom-6 -top-4 bg-gradient-to-t from-[#060a12]/75 via-[#060a12]/40 to-transparent sm:-inset-x-8"
                            aria-hidden
                          />
                        )}
                        <a
                          href={BUSINESS.phoneHref}
                          className="btn-green relative z-10 inline-flex items-center gap-2"
                        >
                        ...
                        <Link
                          ...
                          className="btn-ghost-light relative z-10"
                          onClick={onClose}
                        >
