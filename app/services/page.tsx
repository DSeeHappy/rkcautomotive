...
export default function Services() {
  const services = [
    ...
    },
    {
      ...
      description: 'Tire rotation, balancing, replacement, and wheel alignment services.',
      icon: (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, index) => (
              ...
              >
                <div className="bg-primary-blue rounded-lg w-14 h-14 flex items-center justify-center mb-4">
