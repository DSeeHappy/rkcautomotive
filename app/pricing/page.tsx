...
export const metadata: Metadata = {
  ...
  description:
    'RKC Automotive charges $120/hr — posted online, less than typical Englewood shops ($130–175/hr) and dealerships ($180–220/hr). ASE-certified, written estimates, no upselling. Call (720) 749-3965.',
  openGraph: {
